# TDDUI Bundle - Médicosocial - Transfert de données DUI CDA v1.0.1
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.cda.fr.tddui|current/StructureDefinition/StructureDefinition-tddui-bundle.json)
...
```json
{
  ...
  "title" : "TDDUI Bundle",
  "status" : "active",
  "date" : "2026-06-26T10:33:36+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://interop.esante.gouv.fr/ig/cda/tddui/StructureDefinition/tddui-documentreference"]
      }]
    },
    {
